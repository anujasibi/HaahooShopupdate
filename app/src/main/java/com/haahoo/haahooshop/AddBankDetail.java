...
// finally change the color
        ...
        dialog=new ProgressDialog(AddBankDetail.this,R.style.MyAlertDialogStyle);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("200")){
                        Toast.makeText(AddBankDetail.this, "Successful.Now Withdraw Earnings", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(AddBankDetail.this, Earnings.class);
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(AddBankDetail.this, "Failed."+ot, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(AddBankDetail.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
