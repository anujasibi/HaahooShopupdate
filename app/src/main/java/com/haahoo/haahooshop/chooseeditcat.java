...
public class chooseeditcat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chooseeditcat);
...
// finally change the color
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(chooseeditcat.this,editmaincate.class));
            }
        });
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(jsonArray.length() == 0){
                        Toast.makeText(chooseeditcat.this,"Nothing to display",Toast.LENGTH_SHORT).show();
                    }
