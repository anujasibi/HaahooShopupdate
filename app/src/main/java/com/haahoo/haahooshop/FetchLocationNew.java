...
public class FetchLocationNew extends AppCompatActivity
...
//        getSupportActionBar().setTitle("Map Location Activity");
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sessionManager.getaddres().equals("")){
                    Toast.makeText(FetchLocationNew.this,"Please Choose Your Shop Location",Toast.LENGTH_SHORT).show();
                }
                if(!(sessionManager.getaddres().equals(""))){
                    startActivity(new Intent(FetchLocationNew.this,stepper.class));
                }
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                geocoder = new Geocoder(FetchLocationNew.this, Locale.getDefault());
                ...
                try {
                    ...
                    // Log.d("LOCATION FETCHING", "MM" + address + city + state + country + postalCode + knownName);
                      Toast.makeText(FetchLocationNew.this, address + city + state + country + postalCode + knownName, Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(FetchLocationNew.this,
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                resolvableApiException
                                        .startResolutionForResult(FetchLocationNew.this,
    ...
    public void onBackPressed() {
        startActivity(new Intent(FetchLocationNew.this,choose.class));
    }
