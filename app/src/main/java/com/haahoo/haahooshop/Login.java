...
// finally change the color
        ...
        phoneno.setText(sessionManager.getphone());
...
//                            }
                            ...
                            if(!(status.equals("200"))){
                                Toast.makeText(Login.this, "Failed."+ot, Toast.LENGTH_LONG).show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(payment_status.equals("Payment not done")&&status.equals("200")){
                                Toast.makeText(Login.this, "Please do payment", Toast.LENGTH_LONG).show();
                            ...
                            if(role_type.equals("")&&payment_status.equals("Payment done")){
                                ...
                                Toast.makeText(Login.this, "Please choose your role for further process", Toast.LENGTH_LONG).show();
